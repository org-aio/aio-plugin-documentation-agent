...
export type DictDataSaveVO = Omit<DictDataVO, 'id' | 'createTime'> & {
  id?: number
}
...
// 新增字典数据
export const createDictData = (data: DictDataSaveVO) => {
  return request.post({ url: '/system/dict-data/create', data })
}

// 修改字典数据
export const updateDictData = (data: DictDataSaveVO) => {
